...
export const EMAIL_LOGIN = `${SERVER_URL}auth/email/login`;
export const EMAIL_REGISTER = `${SERVER_URL}auth/email/register`;
...
export const INITIATE_RIDE_CARD = `${SERVER_URL}payment/initialize-ride-card`;
export const VERIFY_RIDE_CARD = `${SERVER_URL}payment/verify-ride-card`;
