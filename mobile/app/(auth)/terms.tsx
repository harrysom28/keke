    ...
    >
      ...
      <View style={tw.style(`bg-[#3C8F7CE6] mb-1 px-4 pt-14 pb-5`)}>
        <View style={tw`flex-row items-center justify-between w-[75%]`}>
          ...
          <Text
            style={tw.style(`text-white text-2xl`, { fontFamily: "RobotoBold" })}
          >
            Terms & Privacy
          </Text>
        </View>
      ...
      <ScrollView contentContainerStyle={tw`px-6 py-4 pb-8`}>
        ...
        <View style={tw`mb-6`}>
          ...
          >
            ...
            transportation services. We act as an intermediary and do not provide
        ...
        <View style={tw`mb-6`}>
          ...
          >
            ...
            Refunds are subject to our refund policy and will be processed within
            5-10 business days.
          </Text>
        </View>
