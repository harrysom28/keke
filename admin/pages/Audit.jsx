...
const ACTION_LABELS = {
  ...
  driver_kyc_approve: 'Driver KYC approved',
  driver_kyc_reject: 'Driver KYC rejected',
  driver_vehicle_approve: 'Driver vehicle approved',
  driver_vehicle_reject: 'Driver vehicle rejected',
